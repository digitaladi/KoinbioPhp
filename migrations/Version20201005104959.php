 ...
 */
final class Version20201005104959 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE fiche ADD taille INT DEFAULT NULL, ADD date_birth_or_buy DATETIME DEFAULT NULL, ADD poid INT DEFAULT NULL, ADD is_actif TINYINT(1) DEFAULT NULL, ADD date_death DATETIME DEFAULT NULL, ADD reason_death LONGTEXT DEFAULT NULL, ADD why_fiche LONGTEXT DEFAULT NULL, ADD bienfaits LONGTEXT DEFAULT NULL');
